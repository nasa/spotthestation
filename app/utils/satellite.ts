...
export async function getSightings(
  ...
  return {
    ...
    firstSightingOrbitPointAt: data.length > 0 ? new Date(data[0].date).toISOString() : null,
  }
}
...
export function getOrbitalSpeed(latitude: number, azimuth: number, elevation: number) {
