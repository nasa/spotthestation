...
it('call getCurrentTimeZome', async () => {
  ...
  expect(await getCurrentTimeZome({ location: { lat: 0, lng: 0 }} as LocationType)).toStrictEqual({ timeZone: 'US/Central', regionFormat: 'US' })
})
...
it('call isDateBetweenHours', () => {
  expect(isDateBetweenHours(new Date('12-12-2012 12:12:12'), new Date('12-12-2012 11:11:11'), new Date('12-12-2012 13:13:13'))).toBeTruthy()
  expect(isDateBetweenHours(new Date('12-12-2012 14:14:14'), new Date('12-12-2012 13:13:13'), new Date('12-12-2012 11:11:11'))).toBeTruthy()
  expect(isDateBetweenHours(new Date('12-12-2012 14:14:14'), new Date('12-12-2012 11:11:11'), new Date('12-12-2012 13:13:13'))).toBeFalsy()
})
