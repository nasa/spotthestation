    ...
    expect(result.sightings).toEqual([
      {
        ...
        minAltitude: 41,
        maxAltitude: 10,
        minAzimuth: expect.closeTo(358.59814615179044, 12),
      ...
      },
      {
        ...
        minAltitude: 16,
        maxAltitude: 10,
        minAzimuth: expect.closeTo(88.98816067556216, 12),
      ...
      },
      {
        ...
        minAltitude: 13,
        maxAltitude: 10,
        minAzimuth: expect.closeTo(269.3630402056663, 12),
      ...
      },
      {
        ...
        minAltitude: 30,
        maxAltitude: 10,
        minAzimuth: expect.closeTo(192.23850125153345, 12),
      ...
      },
      {
        ...
        minAltitude: 10,
        maxAltitude: 18,
        minAzimuth: expect.closeTo(208.20625488206244, 12),
