const it = {
  ...
  notifications: {
    push: {
      ...
      subTitleIos: "La Stazione sta passando sopra di te alle",
      subTitleAndroid: "La Stazione sta passando sopra di te ({{time}}) alle",
    },
    before: {
      title: "Individua la Stazione tra {{amount}} {{units}}!",
      subTitleIos: "La Stazione sta passando sopra di te tra {{amount}} {{units}} a {{location}}",
      subTitleAndroid:
        "La Stazione sta passando sopra di te tra {{amount}} {{units}} ({{time}}) a {{location}}",
      minutes: "minuti",
      hours: "ore",
    },
  ...
  homeScreen: {
    ...
    selectSightings: {
      upcomingSightings: "Prossimi Avvistamenti",
      ...
      shareAllTitle: "La Stazione sta passando sopra {{location}}:",
      shareLink:
        "Per esplorare di più e tracciare la stazione tramite realtà aumentata, scarica l'app a",
      calendarEventTitle: "Individua la Stazione a {{location}}!",
      calendarSuccess: "Evento del calendario creato con successo",
      calendarError: "Impossibile creare l'evento del calendario",
      coach: {
      ...
      shareAll: "Condividi l'elenco delle avvistamenti",
      compass: {
        N: "N",
        NNE: "NNE",
        NE: "NE",
    ...
    coachMarks: {
      ...
      sightingsData:
        'Questa sezione mostra la data/ora e un conto alla rovescia per il prossimo avvistamento della Stazione vicino alla posizione selezionata. Usa l\'opzione "Avvistamenti" per vedere un elenco completo degli avvistamenti passati recenti e dei prossimi avvistamenti.',
  ...
  issView: {
    ...
    details: {
      ...
      dimensionsValue: "{{width}} di larghezza x {{length}} di lunghezza x {{height}} di altezza",
      dateTime: "Data e Ora",
  ...
  settings: {
    ...
    unitsOfMeasurement: "Unità",
    metric: "Metrico",
    imperial: "Imperiale (US)",
