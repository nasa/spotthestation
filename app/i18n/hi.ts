const hi = {
  ...
  homeScreen: {
    ...
    coachMarks: {
      ...
      sightingsData:
        "यह खंड आपको अपने चयनित स्थान के पास अगले आगामी आईएसएस के लिए तारीख/समय और उलटी गिनती दिखाता है। आप हाल के पिछले दृश्यों और आगामी दृश्यों की पूरी सूची देखने के लिए दृश्य बॉक्स पर टैप कर सकते हैं।",
      globeTitle: "इंटरएक्टिव अर्थ",
      globeData:
        "आप स्क्रीन पर स्वाइप करके स्टेशन की वास्तविक समय की स्थिति देख सकते हैं। यह आपको पृथ्वी के साथ बातचीत करने और वास्तविक समय में स्टेशन के स्थान को ट्रैक करने की अनुमति देता है।",
  ...
  settings: {
    ...
    contactUsData: {
      ...
      sendButton: "भेजना",
      reportIssueHint:
        "कृपया समस्या का विवरण, साथ ही चयनित स्थान और स्टेशन को देखने के अवसर की तिथि और समय शामिल करें, ताकि हमारी सहायता टीम आपकी रिपोर्ट की गई समस्या को बेहतर ढंग से पुन: उत्पन्न और निदान कर सके।",
      contactUsOptions: {
  ...
  resources: {
    ...
    faq: {
      ...
      questions: {
        ...
        answer3:
          "अंतर्राष्ट्रीय अंतरिक्ष स्टेशन दिखाई देता है क्योंकि यह सूर्य के प्रकाश को प्रतिबिंबित करता है – यही कारण है कि हम चंद्रमा को देख सकते हैं। हालांकि, चंद्रमा के विपरीत, अंतरिक्ष स्टेशन दिन के दौरान देखने के लिए पर्याप्त उज्ज्वल नहीं है। देखने के अवसर एक महीने में एक बार से लेकर एक सप्ताह में कई बार तक हो सकते हैं क्योंकि सूर्य का प्रकाश स्टेशन से परावर्तित होता है जब यह आपके स्थान पर भोर और सांझ के समय ऊपर से गुजरता है।<br/>" +
          "मोबाइल ऐप अगले 14 दिनों तक के आगामी दर्शन अवसरों की गणना करता है और उन्हें प्रदर्शित करता है। मई 2026 से, NASA की Spot the Station वेबसाइट ने वह सुविधा वापस ला दी है जिससे आप बिना किसी ऐप के, सीधे अपने ब्राउज़र से स्टेशन के दर्शन अवसर खोज सकते हैं: <a href='https://www.nasa.gov/spot-the-station/'>https://www.nasa.gov/spot-the-station/</a> अगले 14 दिनों तक के आगामी दर्शन अवसर देखने के लिए अपना देश और क्षेत्र/शहर चुनें।",
        ...
        answer10:
          "आपके स्थान पर अंधेरा होना चाहिए और अच्छी दृश्यता होनी चाहिए और अंतरिक्ष स्टेशन को देखने के लिए आपके ऊपर होना चाहिए। चूंकि अंतरिक्ष स्टेशन की कक्षा इसे पूरे विश्व में ले जाती है, यह ऐसे समय में ऊपर से गुजर सकता है जब यह दिखाई नहीं देगा – या तो दिन के बीच में या रात के बीच में जब यह पृथ्वी की छाया से ढका होता है। Spot The Station केवल तभी सूचनाएं भेजेगा जब आपके स्थान पर अंतर्राष्ट्रीय अंतरिक्ष स्टेशन को देखने के अवसर होंगे, हर बार जब यह ऊपर होगा तब नहीं। दर्शन अवसरों की गणना 14 दिनों तक पहले से की जाती है, इसलिए नए अनुमानित अवसरों के लिए नियमित रूप से वापस जांच करते रहें।",
        ...
        answer12:
          "अंतर्राष्ट्रीय अंतरिक्ष स्टेशन दिखाई देता है क्योंकि यह सूर्य के प्रकाश को प्रतिबिंबित करता है, ठीक चंद्रमा की तरह। जैसे ही स्टेशन पृथ्वी के चारों ओर यात्रा करता है, यह पृथ्वी की छाया में प्रवेश करता है और बाहर निकलता है। जब यह पृथ्वी की छाया में प्रवेश करता है, तो यह दिखाई नहीं देता, भले ही यह अभी भी ऊपर परिक्रमा कर रहा हो।",
        ...
        answer14:
          "प्रत्येक दृश्य के लिए, Spot the Station ऐप समय, क्षितिज के ऊपर दृश्यता की अवधि, क्षितिज के ऊपर अधिकतम ऊंचाई, वे दिशाएं जहां अंतर्राष्ट्रीय अंतरिक्ष स्टेशन दिखाई देगा और गायब हो जाएगा, और दृश्य के समय चयनित स्थान के लिए पूर्वानुमानित बादल आवरण प्रदर्शित करता है, जिससे उपयोगकर्ताओं को इसे आकाश में सटीक रूप से खोजने में मदद मिलती है।",
        ...
        answer17:
          "हाँ, Spot the Station ऐप में एक वास्तविक समय का मानचित्र शामिल है जो पृथ्वी की परिक्रमा करते समय अंतर्राष्ट्रीय अंतरिक्ष स्टेशन की वर्तमान स्थिति दिखाता है, जिससे उपयोगकर्ताओं को इसकी प्रगति को ट्रैक करने के लिए एक दृश्य संदर्भ मिलता है। स्टेशन की प्रक्षेपवक्र को 2D, 3D, या सैटेलाइट व्यू में देखने के लिए ट्रैकर पृष्ठ पर जाएं।",

        question18: "18. Spot the Station ऐप में संवर्धित वास्तविकता सुविधा क्या है?",
        answer18:
          "Spot the Station ऐप में संवर्धित वास्तविकता सुविधा उपयोगकर्ताओं को फ़ोन के कैमरा व्यू के ऊपर आकाश में अंतर्राष्ट्रीय अंतरिक्ष स्टेशन के पथ का एक आभासी ओवरले देखने की अनुमति देती है। यह सुविधा उपयोगकर्ताओं को स्टेशन की वास्तविक समय की स्थिति के साथ अपने डिवाइस को संरेखित करके स्टेशन को अधिक सटीक रूप से खोजने में मदद करती है।",
        ...
        answer20:
          "Spot the Station की संवर्धित वास्तविकता सुविधा के लिए एक डिवाइस की आवश्यकता होती है जो 3D स्पेस में अपनी अभिविन्यास निर्धारित कर सके। इसके लिए विशिष्ट हार्डवेयर समर्थन की आवश्यकता होती है, जैसे कि एक जाइरोस्कोप या मोशन को-प्रोसेसर। पुराने या बजट डिवाइस अपने मैग्नेटोमीटर सेंसर की सीमाओं के कारण इस कार्यक्षमता का समर्थन नहीं कर सकते हैं। ऐप के सेटिंग मेनू में कम्पास कैलिब्रेशन गाइड का पालन करके सटीकता में सुधार हो सकता है।",

        question21: "21. संवर्धित वास्तविकता सुविधा कैसे काम करती है?",
        answer21:
          "डिवाइस के कैमरे और सेंसर का उपयोग करके, Spot the Station की संवर्धित वास्तविकता सुविधा आकाश में अंतर्राष्ट्रीय अंतरिक्ष स्टेशन की स्थिति को स्क्रीन पर सुपरइम्पोज़ करती है, जो उपयोगकर्ता के डिवाइस को हिलाने पर वास्तविक समय में समायोजित होती है। ऐप उपयोगकर्ताओं को डिवाइस के कैमरे को सही दिशा में इंगित करने के लिए मार्गदर्शन करता है और दिखाता है कि स्टेशन कहां दिखाई देगा और गायब हो जाएगा। कृपया ऐप के सेटिंग मेनू से AR व्यू के लिए ट्यूटोरियल का पालन करें।",
        ...
        answer23:
          "हाँ, Spot the Station ऐप के भीतर संवर्धित वास्तविकता सुविधा डिवाइस के जीपीएस स्थान के आधार पर सटीक स्थिति जानकारी प्रदान करने के लिए डिज़ाइन की गई है। हालाँकि, डिवाइस के कम्पास और सेंसर कैलिब्रेशन के आधार पर सटीकता थोड़ी भिन्न हो सकती है। यदि उपयोगकर्ता विसंगतियों को नोटिस करते हैं, तो ऐप के सेटिंग मेनू से कम्पास कैलिब्रेशन गाइड का पालन करके डिवाइस के कम्पास को पुनः कैलिब्रेट करें। पुराने या बजट डिवाइस अपने मैग्नेटोमीटर सेंसर की सीमाओं के कारण इस कार्यक्षमता का समर्थन नहीं कर सकते हैं।",
        ...
        answer25:
          "Spot the Station ऐप में सबसे अच्छा संवर्धित वास्तविकता अनुभव के लिए, खुले क्षेत्र में सुविधा का उपयोग करें जहां आकाश का स्पष्ट दृश्य हो। ऊंची इमारतों या पेड़ों जैसी बाधाओं से बचें, क्योंकि ये दृश्यता को अवरुद्ध कर सकते हैं। डिवाइस के कम्पास को कैलिब्रेट करें (सेटिंग मेनू में कम्पास कैलिब्रेशन गाइड का पालन करें) और सुनिश्चित करें कि स्थान सेवाएं और कैमरा अनुमतियां सुचारू कार्य के लिए सक्षम हैं।",

        question26: "26. क्या संवर्धित वास्तविकता सुविधा iOS और Android उपकरणों पर उपलब्ध है?",
        answer26:
          "हाँ, Spot the Station ऐप की संवर्धित वास्तविकता सुविधा iOS और Android मोबाइल और टैबलेट उपकरणों पर उपलब्ध है, जब तक कि आपका डिवाइस हार्डवेयर आवश्यकताओं को पूरा करता है। पुराने या बजट डिवाइस अपने मैग्नेटोमीटर सेंसर की सीमाओं के कारण इस कार्यक्षमता का समर्थन नहीं कर सकते हैं।",
        ...
        answer30:
          "Spot the Station ऐप के समर्थन के लिए, ऐप के सेटिंग मेनू में संपर्क करें विकल्प के माध्यम से संपर्क करें या <a href='mailto:hq-spotthestation@mail.nasa.gov'>Spot the Station टीम को ईमेल करें</a>।",
      },
    },
    astronauts: {
