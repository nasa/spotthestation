const hi = {
  ...
  resources: {
    ...
    liveDescription:
      "वर्तमान में, भूमि का लाइव वीडियो एक आईएसएस पर लगी एक बाह्य HD कैमरे से स्ट्रीम हो रहा है। कैमरा धरती की ओर देख रहा है जिसमें कभी-कभी सोलर पैनल भी आता है। इस लाइव स्ट्रीम को देखने के लिए, कृपया इस NASA वेब पृष्ठ पर जाएं",
    liveLink: "इस NASA वेब पृष्ठ",
    tabs: {
      news: "समाचार",
      about: "के बारे में",
      details: "विवरण",
