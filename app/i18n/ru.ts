const ru = {
  ...
  resources: {
    ...
    liveDescription:
      "В настоящее время с внешней HD-камеры, установленной на МКС, транслируется видео Земли в режиме реального времени. Камера смотрит на Землю, иногда мелькает солнечная панель. Чтобы просмотреть этот прямой эфир, посетите",
    liveLink: "эту веб-страницу NASA",
    tabs: {
      news: "Новости",
      about: "О нас",
      details: "Детали",
