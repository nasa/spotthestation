const ru = {
  ...
  homeScreen: {
    ...
    coachMarks: {
      ...
      sightingsData:
        "Этот раздел показывает дату/время и обратный отсчет до следующего наблюдения станции рядом с вашим выбранным местоположением. Вы можете нажать на блок Наблюдения, чтобы увидеть полный список недавних прошедших и предстоящих наблюдений.",
  ...
  settings: {
    ...
    contactUsData: {
      ...
      reportIssueHint:
        "Пожалуйста, укажите описание проблемы, а также выбранное местоположение, дату и время возможности наблюдения станции, чтобы наша служба поддержки могла лучше воспроизвести и диагностировать сообщённую вами проблему.",
      contactUsOptions: {
  ...
  resources: {
    ...
    faq: {
      ...
      questions: {
        ...
        answer3:
          "Международная космическая станция видна, потому что отражает солнечный свет — по той же причине мы видим Луну. Однако, в отличие от Луны, космическая станция недостаточно яркая, чтобы ее можно было увидеть днем. Возможности наблюдения могут варьироваться от одного раза в месяц до нескольких раз в неделю, поскольку солнечный свет отражается от станции, когда она проходит над вашим местоположением на рассвете и в сумерках.<br/>" +
          "Мобильное приложение рассчитывает и отображает предстоящие возможности наблюдения на срок до 14 дней. С мая 2026 года на сайте NASA Spot the Station вернулась функция поиска возможностей наблюдения за станцией прямо из браузера, без приложения: <a href='https://www.nasa.gov/spot-the-station/'>https://www.nasa.gov/spot-the-station/</a> Выберите свою страну и регион/город, чтобы увидеть предстоящие возможности наблюдения на срок до 14 дней.",
        ...
        answer6:
          "Приложение Spot the Station отправляет push-уведомления, чтобы предупредить пользователей о предстоящих пролётах Международной космической станции. Пользователи должны убедиться, что разрешения на уведомления приложения включены в настройках их устройства. Обратите внимание, что приложение рассчитывает возможности наблюдения для выбранного местоположения на срок до 14 дней, поэтому вы можете перестать получать уведомления, если какое-то время не пользуетесь приложением.",

        question7: "7. Могу ли я настроить уведомления в приложении Spot the Station?",
        answer7:
          "Приложение Spot the Station имеет возможность настраивать персонализированные настройки уведомлений, чтобы получать push-уведомления, специфичные для предпочтительного местоположения и времени пользователя. Настройки уведомлений можно найти на странице настроек приложения, где пользователи могут включить уведомления для всех предстоящих событий или настроить уведомления для текущего выбранного местоположения. Пользователи могут настроить уведомления для других местоположений через настройки местоположения. Вы можете перейти на страницу наблюдений с главной страницы, чтобы включать/выключать уведомления для каждой предстоящей возможности наблюдения для выбранного местоположения.",

        question8: "8. Что делать, если я не получаю уведомления?",
        answer8:
          "Пользователи должны проверить предпочтения уведомлений в приложении Spot the Station (Настройки уведомлений на странице настроек), чтобы подтвердить, что устройство настроено на получение уведомлений в предпочтительном местоположении и времени. Если пользователи по-прежнему не получают уведомления, они должны убедиться, что уведомления включены в настройках их устройства. Обратите внимание, что приложение рассчитывает возможности наблюдения для выбранного местоположения на срок до 14 дней при каждом открытии приложения, поэтому вы можете перестать получать уведомления, если не заходите в него регулярно.",
        ...
        answer10:
          "Для того чтобы вы могли увидеть станцию, там, где вы находитесь, должно быть темно, и космическая станция должна быть над вами. Поскольку орбита космической станции проходит по всему земному шару, она может проходить над вами в моменты, когда она не будет видна — либо в середине дня, либо в середине ночи, когда она находится в тени Земли. Spot The Station отправит уведомления только тогда, когда будет возможность увидеть Международную космическую станцию в вашем местоположении, а не каждый раз, когда она будет над вами. Возможности наблюдения рассчитываются на срок до 14 дней вперёд, поэтому регулярно проверяйте новые прогнозируемые возможности.",
        ...
        answer12:
          "Международная космическая станция видна, потому что отражает солнечный свет, как и Луна. По мере движения станции вокруг Земли она входит в тень Земли и выходит из неё. Когда она входит в тень Земли, она не видна, даже если всё ещё находится на орбите над вами.",
        ...
        answer14:
          "Для каждого наблюдения приложение Spot the Station отображает время, продолжительность видимости над горизонтом, максимальную высоту над горизонтом, направления, где Международная космическая станция появится и исчезнет, а также прогнозируемую облачность для выбранного местоположения на момент наблюдения, помогая пользователям точно ее локализовать на небе.",
        ...
        answer17:
          "Да, приложение Spot the Station включает карту в реальном времени, показывающую текущее положение Международной космической станции, когда она облетает Землю, предоставляя пользователям визуальную ссылку для отслеживания ее прогресса. Посетите страницу трекера, чтобы увидеть траекторию станции в 2D-, 3D- или спутниковом виде.",

        question18: "18. Что такое функция дополненной реальности в приложении Spot the Station?",
        answer18:
          "Функция дополненной реальности в приложении Spot the Station позволяет пользователям видеть виртуальное наложение пути Международной космической станции на небе поверх изображения с камеры телефона. Эта функция помогает пользователям более точно локализовать станцию, выравнивая свое устройство с реальным положением станции.",
        ...
        answer23:
          "Да, функция дополненной реальности в приложении Spot the Station разработана для предоставления точной информации о положении на основе GPS-локации устройства. Однако точность может немного варьироваться в зависимости от калибровки компаса и датчиков устройства. Если пользователи замечают расхождения, откалибруйте компас устройства, следуя руководству по калибровке компаса из меню настроек приложения. Более старые или бюджетные устройства могут не поддерживать эту функциональность из-за ограничений их датчика-магнитометра.",
        ...
        answer25:
          "Для лучшего опыта дополненной реальности в приложении Spot the Station используйте функцию в открытой области с ясным видом на небо. Избегайте препятствий, таких как высокие здания или деревья, так как они могут блокировать видимость. Откалибруйте компас устройства (следуйте руководству по калибровке компаса в меню настроек) и убедитесь, что службы определения местоположения и разрешения камеры включены для плавной работы.",

        question26: "26. Доступна ли функция дополненной реальности на устройствах iOS и Android?",
        answer26:
          "Да, функция дополненной реальности приложения Spot the Station доступна на мобильных устройствах и планшетах iOS и Android, если ваше устройство соответствует аппаратным требованиям. Более старые или бюджетные устройства могут не поддерживать эту функциональность из-за ограничений их датчика-магнитометра.",
        ...
        answer30:
          "Для поддержки по приложению Spot the Station свяжитесь через опцию «Связаться с нами» в меню настроек приложения или <a href='mailto:hq-spotthestation@mail.nasa.gov'>отправьте электронное письмо команде Spot the Station</a>.",
      },
    },
    astronauts: {
