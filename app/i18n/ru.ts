const ru = {
  ...
  notifications: {
    push: {
      title: "Посмотрите на МКС сейчас!",
      subTitle: "МКС проходит над вами в",
    },
    before: {
      titleOne: "Посмотрите на МКС через",
      titleTwo: "минут!",
      subTitleOne: "МКС будет проходить над вами через",
      subTitleTwo: "минут в",
    },
  },
  units: {
  ...
  tabNavigator: {
    homeTab: "Главная",
    issViewTab: "Вид на МКС",
    issNowTab: "МКС сейчас",
  ...
  onboarding: {
    splash: {
      ...
      subTitle: "Взгляните в небо и увидьте Международную космическую станцию (МКС)",
    },
    completeProfile: {
      notification: {
  ...
  homeScreen: {
    ...
    selectSightings: {
      ...
      coach: {
        ...
        sun: "МКС проходит над горизонтом в выбранном местоположении в дневное время.",
      },
    },
    coachMarks: {
      skip: "Пропустить тур",
