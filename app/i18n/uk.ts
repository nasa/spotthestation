const uk = {
  ...
  homeScreen: {
    ...
    coachMarks: {
      ...
      sightingsData:
        "Цей розділ показує вам дату/час та відлік до наступного наближення станції до вашої обраної локації. Ви можете натиснути на блок 'Спостереження', щоб побачити повний список нещодавніх минулих та майбутніх спостережень.",
  ...
  settings: {
    ...
    contactUsData: {
      ...
      reportIssueHint:
        "Будь ласка, додайте опис проблеми, а також вибране місцезнаходження, дату й час можливості спостереження станції, щоб наша служба підтримки могла краще відтворити та діагностувати повідомлену вами проблему.",
      contactUsOptions: {
  ...
  resources: {
    ...
    faq: {
      ...
      questions: {
        ...
        answer3:
          "Міжнародну космічну станцію видно, тому що вона відбиває світло Сонця — з тієї ж причини ми бачимо Місяць. Однак, на відміну від Місяця, космічна станція недостатньо яскрава, щоб її можна було побачити вдень. Можливості спостереження можуть варіюватися від одного разу на місяць до кількох разів на тиждень, оскільки сонячне світло відбивається від станції, коли вона проходить над вашим місцем розташування на світанку і в сутінках.<br/>" +
          "Мобільний застосунок розраховує та відображає майбутні можливості спостереження на термін до 14 днів. З травня 2026 року на вебсайті NASA Spot the Station повернулася функція пошуку можливостей спостереження за станцією прямо з вашого браузера, без застосунку: <a href='https://www.nasa.gov/spot-the-station/'>https://www.nasa.gov/spot-the-station/</a> Виберіть свою країну та регіон/місто, щоб побачити майбутні можливості спостереження на термін до 14 днів.",
        ...
        answer6:
          "Додаток Spot the Station надсилає push-сповіщення, щоб попередити користувачів про майбутні прольоти Міжнародної космічної станції. Користувачі повинні переконатися, що дозволи на сповіщення додатка увімкнені в налаштуваннях їхнього пристрою. Зверніть увагу, що додаток розраховує можливості спостереження для вибраного місця розташування на термін до 14 днів, тому ви можете перестати отримувати сповіщення, якщо певний час не користуєтеся додатком.",

        question7: "7. Чи можу я налаштувати сповіщення в додатку Spot the Station?",
        answer7:
          "Додаток Spot the Station має можливість налаштовувати персоналізовані налаштування сповіщень, щоб отримувати push-сповіщення, специфічні для бажаного місця розташування та часу користувача. Налаштування сповіщень можна знайти на сторінці налаштувань додатка, де користувачі можуть увімкнути сповіщення для всіх майбутніх подій або налаштувати сповіщення для поточного вибраного місця розташування. Користувачі можуть налаштувати сповіщення для інших місць через налаштування місця розташування. Ви можете перейти на сторінку спостережень із головної сторінки, щоб вмикати/вимикати сповіщення для кожної майбутньої можливості спостереження для вибраного місця розташування.",

        question8: "8. Що робити, якщо я не отримую сповіщення?",
        answer8:
          "Користувачі повинні перевірити налаштування сповіщень у додатку Spot the Station (Налаштування сповіщень на сторінці налаштувань), щоб підтвердити, що пристрій налаштований на отримання сповіщень у бажаному місці та часі. Якщо користувачі все ще не отримують сповіщення, вони повинні переконатися, що сповіщення увімкнені в налаштуваннях їхнього пристрою. Зверніть увагу, що додаток розраховує можливості спостереження для вибраного місця розташування на термін до 14 днів щоразу, коли ви відкриваєте додаток, тому ви можете перестати отримувати сповіщення, якщо не заходите в нього регулярно.",
        ...
        answer10:
          "Повинно бути темно з хорошою видимістю у вашому місці розташування, і космічна станція повинна бути над вами, щоб її побачити. Оскільки орбіта космічної станції проходить по всьому світу, вона може проходити над вами в моменти, коли вона не буде видима — або в середині дня, або в середині ночі, коли вона перебуває в тіні Землі. Spot The Station надішле сповіщення лише тоді, коли будуть можливості побачити Міжнародну космічну станцію у вашому місці розташування, а не кожного разу, коли вона буде над вами. Можливості спостереження розраховуються на термін до 14 днів наперед, тому регулярно перевіряйте нові прогнозовані можливості.",
        ...
        answer12:
          "Міжнародна космічна станція видима, тому що відбиває сонячне світло, так само як і Місяць. Коли станція рухається навколо Землі, вона входить у тінь Землі та виходить з неї. Коли вона входить у тінь Землі, вона не видима, навіть якщо все ще обертається над вами.",
        ...
        answer14:
          "Для кожного спостереження додаток Spot the Station відображає час, тривалість видимості над горизонтом, максимальну висоту над горизонтом, напрямки, де Міжнародна космічна станція з'явиться і зникне, а також прогнозовану хмарність для вибраного місця розташування на момент спостереження, допомагаючи користувачам точно її локалізувати на небі.",
        ...
        answer17:
          "Так, додаток Spot the Station включає карту в реальному часі, яка показує поточне положення Міжнародної космічної станції, коли вона обертається навколо Землі, надаючи користувачам візуальне посилання для відстеження її прогресу. Відвідайте сторінку трекера, щоб побачити траєкторію станції у 2D-, 3D- або супутниковому вигляді.",

        question18: "18. Що таке функція доповненої реальності в додатку Spot the Station?",
        answer18:
          "Функція доповненої реальності в додатку Spot the Station дозволяє користувачам бачити віртуальне накладення шляху Міжнародної космічної станції на небі поверх зображення з камери телефона. Ця функція допомагає користувачам більш точно локалізувати станцію, вирівнюючи свій пристрій з реальним положенням станції.",
        ...
        answer20:
          "Функція доповненої реальності Spot the Station працює лише на пристроях, які можуть визначати свою орієнтацію в 3D-просторі. Це вимагає наявності певного обладнання, такого як гіроскоп або співпроцесор руху. Більш старі або бюджетні пристрої можуть не підтримувати цю функціональність через обмеження їхнього датчика-магнітометра. Точність можна підвищити, дотримуючись інструкції з калібрування компаса в меню налаштувань додатка.",

        question21: "21. Як працює функція доповненої реальності?",
        answer21:
          "Використовуючи камеру і датчики пристрою, функція доповненої реальності Spot the Station накладає місце розташування Міжнародної космічної станції на небі на екран, коригуючи в реальному часі, коли користувач переміщує пристрій. Додаток направляє користувачів в правильному напрямку і показує, де станція з'явиться і зникне. Будь ласка, дотримуйтесь посібника для AR-перегляду в меню налаштувань додатка.",
        ...
        answer23:
          "Так, функція доповненої реальності в додатку Spot the Station розроблена для надання точної інформації про положення на основі GPS-локації пристрою. Однак точність може трохи варіюватися в залежності від калібрування компаса і датчиків пристрою. Якщо користувачі помічають розбіжності, відкалібруйте компас пристрою, дотримуючись інструкції з калібрування компаса в меню налаштувань додатка. Більш старі або бюджетні пристрої можуть не підтримувати цю функціональність через обмеження їхнього датчика-магнітометра.",
        ...
        answer25:
          "Для кращого досвіду доповненої реальності в додатку Spot the Station використовуйте функцію у відкритій області з ясним видом на небо. Уникайте перешкод, таких як високі будівлі або дерева, оскільки вони можуть блокувати видимість. Відкалібруйте компас пристрою (дотримуйтесь інструкції з калібрування компаса в меню налаштувань) і переконайтеся, що служби визначення місця розташування і дозволи камери увімкнені для плавної роботи.",

        question26: "26. Чи доступна функція доповненої реальності на пристроях iOS та Android?",
        answer26:
          "Так, функція доповненої реальності додатка Spot the Station доступна на мобільних пристроях і планшетах iOS та Android, якщо ваш пристрій відповідає апаратним вимогам. Більш старі або бюджетні пристрої можуть не підтримувати цю функціональність через обмеження їхнього датчика-магнітометра.",
        ...
        answer30:
          "Для підтримки по додатку Spot the Station зв'яжіться через опцію «Зв'язатися з нами» в меню налаштувань додатка або <a href='mailto:hq-spotthestation@mail.nasa.gov'>надішліть електронний лист команді Spot the Station</a>.",
      },
    },
    astronauts: {
