const uk = {
  ...
  resources: {
    ...
    liveTitle: "Відео Землі високої чіткості в прямому ефірі",
    liveDescription:
      "Наразі відео Землі транслюється з зовнішньої HD-камери, встановленої на Міжнародній космічній станції. Камера дивиться на Землю, іноді проходить сонячний панель через зображення. Щоб переглянути цей прямий ефір, відвідайте",
    liveLink: "цю веб-сторінку NASA",
    tabs: {
      news: "Новини",
      about: "Про станцію",
      details: "Деталі",
