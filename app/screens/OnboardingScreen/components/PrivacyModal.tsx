...
import { ViewStyle, View, PressableProps, TextStyle, Linking, Pressable, Image, ImageStyle } from "react-native"
...
export function PrivacyModal({ onPressSkip, onPressAgree }: PrivacyModalProps) {
  return (
    ...
    style={[$coachModalBodyContainer, { marginTop: normalizeHeight(.1) }]}
  >
    ...
    <Pressable
      onPress={() => Linking.openURL('https://www.nasa.gov/about/highlights/HP_Privacy.html#privacy')}
