...
export const Location = types.model("Location", {
  ...
  sightingsHistory: types.optional(types.array(Sighting), []),
  lastSightingOrbitPointAt: types.maybeNull(types.string),
  firstHistorySightingOrbitPointAt: types.maybeNull(types.string),
  sightingsHistoryLastUpdatedAt: types.maybeNull(types.string),
