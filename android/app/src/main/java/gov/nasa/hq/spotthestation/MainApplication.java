...
import gov.nasa.hq.spotthestation.newarchitecture.MainApplicationReactNativeHost;
  ...
  private static void initializeFlipper(
    ...
    if (BuildConfig.DEBUG) {
      try {
        ...
        */
        Class<?> aClass = Class.forName("gov.nasa.hq.spotthestation.ReactNativeFlipper");
        aClass
