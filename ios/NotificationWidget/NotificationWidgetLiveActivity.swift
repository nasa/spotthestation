...
struct NotificationWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = NotificationWidgetAttributes(name: "Me")
    static let contentState = NotificationWidgetAttributes.ContentState(value: 3)
